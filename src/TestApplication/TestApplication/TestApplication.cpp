...
namespace ItSoftware::CppIncludeWindows::TestApplication
{
    ...
    // constexpr
    //
    constexpr auto CLR_GREEN = L"\033[32m";
    constexpr auto CLR_WHITE = L"\033[37;1m";
    constexpr auto CLR_RESET = L"\033[0m";
...
//      Redirects to ItSoftware::CppIncludeWindows::TestApplication::wmain.
//
int wmain(int argc, const wchar_t* argv[])
{
    return ItSoftware::CppIncludeWindows::TestApplication::wmain(argc, argv);
}